...
{body}";
        ...
        public void SendVerificationEmail(string recipientEmail, int memberId, string confirmCode)
        {
            ...
            mms.Subject = "Sierra會員註冊";
            mms.Body = $"歡迎您成為Sierra的會員，請點擊以下連結進行驗證：{confrimUrl}";
